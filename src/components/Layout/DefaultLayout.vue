<template>
  ...
  <div class="text-left">
    ...
    <div class="flex overflow-hidden bg-white pt-16">
            ...
            <div class="flex-1 px-3 bg-white divide-y space-y-1">
              <ul class="space-y-2 pb-2">
                ...
                <li>
                  ...
                  >
                    ...
                    <span class="ml-3 flex-1 whitespace-nowrap">Files</span>
                    <span
                      class="bg-gray-200 text-gray-800 ml-3 text-sm font-medium inline-flex items-center justify-center px-2 rounded-full"
                      >New</span
                    >
              ...
              <div class="space-y-2 pt-2">
                ...
                >
                  ...
                  <span class="ml-4">By me a coffee</span>
                </a>

                <a
                  href="https://github.com/FotieMConstant/tune-gpt/issues"
                  target="_blank"
                  class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2"
                >
                  <svg
                  ...
                  <span class="ml-3">Report a bug</span>
                </a>
                <p
                  class="text-center text-sm text-gray-500 absolute bottom-3 right-0 left-0"
                >
                  <a
                    href="https://fotiecodes.com"
                    class="hover:underline"
                    target="_blank"
                    >Made with ☕ by fotiecodes</a
                  >.
                </p>
              </div>
            </div>
      ...
      <div
        id="main-content"
        class="h-screen w-full bg-gray-100 relative overflow-y-auto lg:ml-64"
      >
        <!-- main content -->
        <main class="p-6 px-10">
          <slot />
        </main>
        <!--/ main content -->
